...
export const translations: Record<'zh' | 'en' | 'ja', Translations> = {
  zh: {
    ...
    'nav.resume': '简历',
    'nav.about': '关于',
    'footer.copyright': '© 2026 Capyexports. Capy 从不恐慌，因为内核在它的心中。',
  ...
  en: {
    ...
    'nav.resume': 'Resume',
    'nav.about': 'About',
    'footer.copyright': '© 2026 Capyexports. Capy never panics, because the kernel is in its heart.',
    'footer.social.twitter': 'Twitter',
    'footer.social.github': 'GitHub',
  ...
  ja: {
    ...
    'nav.resume': '履歴書',
    'nav.about': 'について',
    'footer.copyright': '© 2026 Capyexports. Capyは決してパニックにならない、カーネルがその心にあるから。',
    'footer.social.twitter': 'Twitter',
    'footer.social.github': 'GitHub',
